...
export function Sheet({
  ...
  return (
    <Modal
      ...
      // Edge-to-edge modal window, so the keyboard insets the sheet reads match
      ...
      <KeyboardAvoidingView behavior="padding" automaticOffset style={{ flex: 1 }}>
        <Pressable className="flex-1 justify-end bg-black/40" onPress={onClose}>
          <Pressable
            ...
            style={[{ paddingBottom: insets.bottom + 12, maxHeight: '100%' }, shadow]}
            className="shrink rounded-t-xl bg-surface">
            ...
            <View className="shrink px-5 pb-2 pt-2">{children}</View>
          </Pressable>
        </Pressable>
