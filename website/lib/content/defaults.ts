...
export const DEFAULT_LANDING_SECTIONS: LandingSection[] = [
  ...
  },
  {
    ...
    sub: "Expert tips, helpful guides, and the latest insights on birthday reminders, family calendars, and never missing a special occasion.",
  ...
  },
  {
    ...
    sub: "Everything about birthday reminders, shared calendars, and never missing a date again.",
    items: [
      {
        id: "faq-1",
