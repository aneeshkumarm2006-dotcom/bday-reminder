...
export const DEFAULT_LEGAL: Record<LegalDocKey, LegalDoc> = {
  privacy: {
    ...
    html: [
      ...
      "</ul>",
      "<h2>Deleting your data or your account</h2>",
      `<p>This applies to ${siteConfig.name}, published on the App Store and Google Play as <strong>Circle the date</strong>. Both names refer to the same app and the same account.</p>`,
      "<h3>Delete part of your data, keeping your account</h3>",
      "<ul>",
      "<li>Open a person and choose Delete. This also removes their events, their notes and gift notes, their photo, and any reminders still scheduled for them.</li>",
      "<li>Delete an individual event, note, or gift note from the person&rsquo;s page.</li>",
      "<li>Delete a shared list you own, or leave a list you were invited to.</li>",
      "<li>Disconnect a linked Google account from Settings; we revoke the token with Google and delete our stored copy.</li>",
      "</ul>",
      "<h3>Delete your whole account</h3>",
      "<ul>",
      "<li><strong>In the app:</strong> Settings &rarr; Delete account &rarr; confirm.</li>",
      `<li><strong>On the web:</strong> sign in at <a href="${siteConfig.url}/settings">birthdayreminders.us/settings</a>, then Settings &rarr; Delete account &rarr; confirm.</li>`,
      `<li><strong>If you cannot sign in:</strong> email <a href="mailto:${siteConfig.contactEmail}">${siteConfig.contactEmail}</a> from the address on the account and we will delete it for you.</li>`,
      "</ul>",
      "<h3>What is deleted, and what is kept</h3>",
      "<p><strong>Deleted immediately, with no retention period and no backup copy:</strong> your account and login, the people you added, their events, notes, gift notes and photos, every scheduled and sent reminder, shared lists you own, invitations you sent, your saved sign-in sessions, and any connected Google account (revoked with Google at the same time).</p>",
      "<p><strong>Kept:</strong> if someone else added a person to <em>their own</em> list, that entry belongs to them and stays in their account &mdash; it simply stops being linked to you. We keep an anonymous, account-wide count of messages sent for fair-use limits; it contains no personal information and cannot be traced back to you.</p>",
      "<p>Account deletion is immediate and cannot be undone.</p>",
      "<h2>Contact</h2>",
  ...
  terms: {
    ...
    html: [
      `<p>By using ${siteConfig.name}, you agree to the following.</p>`,
      "<h2>The service</h2>",
