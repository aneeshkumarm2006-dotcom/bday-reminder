...
export const DEFAULT_LEGAL: Record<LegalDocKey, LegalDoc> = {
  privacy: {
    ...
    html: [
      ...
      "<p>You can delete your account and everything in it yourself, at any time:</p>",
      "<ul>",
      "<li><strong>In the app:</strong> Settings &rarr; Delete account.</li>",
      `<li><strong>On the web:</strong> sign in at <a href="${siteConfig.url}/settings">birthdayreminders.us/settings</a> and choose Delete account.</li>`,
      "</ul>",
      "<p>This permanently erases your account, the people you&rsquo;ve added, their events, notes, gift notes, reminders, shared lists you own, and any connected accounts. It cannot be undone, and we keep no backup copy afterwards.</p>",
      `<p>If you can&rsquo;t sign in, email <a href="mailto:${siteConfig.contactEmail}">${siteConfig.contactEmail}</a> from the address on the account and we&rsquo;ll delete it for you.</p>`,
      "<h2>Contact</h2>",
